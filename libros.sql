...
-- Tiempo de generación: 02-03-2026 a las 21:01:04
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_insert_socio` (`c1_numero` INT(11), `c2_nombre` VARCHAR(45), `c3_apellido` VARCHAR(45), `c4_direccion` VARCHAR(255), `c5_telefono` VARCHAR(10))   INSERT INTO
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_tipoAutor` (`variable` VARCHAR(20))   SELECT AUT_APELLIDO AS 'AUTOR', TIPO_AUTOR 
FROM AUTOR
...
(1, 'Ana', 'Ruiz', 'Cra 14 calle 23', '3213357665'),
...
(14, 'Luis', 'Rodriguez', 'Cra 14 calle 35', '3213363489');
